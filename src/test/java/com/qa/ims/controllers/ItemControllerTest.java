...
public class ItemControllerTest {
	...
	public void testCreate() {
		final String I_NAME = "Bread Basket";
		final Double I_Value = 6.99;
	...
	public void testReadAll() {
		...
		items.add(new Item(5L, "Hat Stand", 10.99));
	...
	public void testUpdate() {
		Item updated = new Item(6L, "Giant Sofa", 59.99);

		Mockito.when(this.utils.getLong()).thenReturn(6L);
